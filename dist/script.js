...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionTuElems(event, elem, prop) {
  ...
  bindActionTuElems('click', windowForm, 'form');
  bindActionTuElems('input', windowHeight, 'height');
  bindActionTuElems('input', windowWidth, 'width');
  bindActionTuElems('change', windowType, 'type');
  bindActionTuElems('change', windowProfile, 'profile'); //   windowForm.forEach( (item, i) => {
...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); // phoneInputs.forEach( item => {
...
var modals = function modals() {
  function binModal(triggerSelector, modalSelector, closeSelector) {
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeClickOverlay) {
        ...
        document.body.style.owerflow = 'hodden'; // document.body.classList.add('modal-open');
      }
    });
  }
  ...
  binModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 60000);
};
...
function tabs(headerSElector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    var target = e.target; // проверяем что клил был совершен именно в таб. Если в какой-то внутренний элемент, то проверяем что радитель это таб
